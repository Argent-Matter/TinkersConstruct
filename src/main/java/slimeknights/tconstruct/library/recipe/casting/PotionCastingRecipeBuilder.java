...
public class PotionCastingRecipeBuilder extends AbstractRecipeBuilder<PotionCastingRecipeBuilder> {
  ...
  public void save(Consumer<FinishedRecipe> consumerIn) {
    this.save(consumerIn, Objects.requireNonNull(Registry.ITEM.getKey(this.result)));
  }
  ...
  private class Result extends AbstractFinishedRecipe {
    ...
    public void serializeRecipeData(JsonObject json) {
      ...
      json.addProperty("result", Objects.requireNonNull(Registry.ITEM.getKey(result)).toString());
