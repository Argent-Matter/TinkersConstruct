...
public final class TinkerFluids extends TinkerModule {
  ...
  // basic
  public static final FluidObject<SimpleFlowableFluid> blood = FLUIDS.register("blood", Material.WATER, 0);
  public static final FluidObject<SimpleFlowableFluid> venom = FLUIDS.register("venom", Material.WATER, 0);
  ...
  public static final FluidObject<SimpleFlowableFluid> earthSlime = FLUIDS.register("earth_slime", "slime",  SlimeFluid.Source::new, SlimeFluid.Flowing::new, Material.WATER, 0);
  public static final FluidObject<SimpleFlowableFluid> skySlime   = FLUIDS.register("sky_slime",             SlimeFluid.Source::new, SlimeFluid.Flowing::new, Material.WATER, 0);
  public static final FluidObject<SimpleFlowableFluid> enderSlime = FLUIDS.register("ender_slime",           SlimeFluid.Source::new, SlimeFluid.Flowing::new, Material.WATER, 0);
  public static final FluidObject<SimpleFlowableFluid> magma      = FLUIDS.register("magma",                 SlimeFluid.Source::new, SlimeFluid.Flowing::new, Material.WATER, 3);
  public static final FluidObject<DirectionalSlimeFluid> ichor    = FLUIDS.registerUpsideDown("ichor",       DirectionalSlimeFluid.Source::new, DirectionalSlimeFluid.Flowing::new, Material.WATER, 3);
  ...
  // foods
  public static FluidObject<SimpleFlowableFluid> honey        = FLUIDS.register("honey",         Material.WATER, 0);
  public static FluidObject<SimpleFlowableFluid> beetrootSoup = FLUIDS.register("beetroot_soup", Material.WATER, 0);
  public static FluidObject<SimpleFlowableFluid> mushroomStew = FLUIDS.register("mushroom_stew", Material.WATER, 0);
  public static FluidObject<SimpleFlowableFluid> rabbitStew   = FLUIDS.register("rabbit_stew",   Material.WATER, 0);
  ...
  public static final RegistryObject<UnplaceableFluid> potion = FLUIDS.registerFluid("potion", () -> new UnplaceableFluid(potionBucket));
  ...
  // base molten fluids
  public static final FluidObject<SimpleFlowableFluid> searedStone   = FLUIDS.register("seared_stone",   Material.LAVA,  6);
  public static final FluidObject<SimpleFlowableFluid> scorchedStone = FLUIDS.register("scorched_stone", Material.LAVA,  4);
  public static final FluidObject<SimpleFlowableFluid> moltenClay    = FLUIDS.register("molten_clay",    Material.LAVA,  3);
  public static final FluidObject<SimpleFlowableFluid> moltenGlass   = FLUIDS.register("molten_glass",   Material.LAVA,  1);
  public static final FluidObject<SimpleFlowableFluid> liquidSoul    = FLUIDS.register("liquid_soul",    Material.LAVA,  2);
  // ceramics compat
  public static final FluidObject<SimpleFlowableFluid> moltenPorcelain = FLUIDS.register("molten_porcelain", Material.LAVA, 2);
  // fancy molten fluids
  public static final FluidObject<SimpleFlowableFluid> moltenObsidian = FLUIDS.register("molten_obsidian", Material.LAVA, 3);
  public static final FluidObject<SimpleFlowableFluid> moltenEnder    = FLUIDS.register("molten_ender", "ender", Material.LAVA, 5);
  public static final FluidObject<SimpleFlowableFluid> blazingBlood   = FLUIDS.register("blazing_blood",   Material.LAVA, 15);

  // ores
  public static final FluidObject<SimpleFlowableFluid> moltenEmerald  = FLUIDS.register("molten_emerald",  Material.LAVA,  9);
  public static final FluidObject<SimpleFlowableFluid> moltenQuartz   = FLUIDS.register("molten_quartz",   Material.LAVA,  6);
  public static final FluidObject<SimpleFlowableFluid> moltenAmethyst = FLUIDS.register("molten_amethyst", Material.LAVA, 11);
  public static final FluidObject<SimpleFlowableFluid> moltenDiamond  = FLUIDS.register("molten_diamond",  Material.LAVA, 13);
  public static final FluidObject<SimpleFlowableFluid> moltenDebris   = FLUIDS.register("molten_debris",   Material.LAVA, 14);
  // metal ores
  public static final FluidObject<SimpleFlowableFluid> moltenIron   = FLUIDS.register("molten_iron",   Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenGold   = FLUIDS.register("molten_gold",   Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenCopper = FLUIDS.register("molten_copper", Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenCobalt = FLUIDS.register("molten_cobalt", Material.LAVA,  8);
  // alloys
  public static final FluidObject<SimpleFlowableFluid> moltenSlimesteel     = FLUIDS.register("molten_slimesteel",      Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenAmethystBronze = FLUIDS.register("molten_amethyst_bronze", Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenRoseGold       = FLUIDS.register("molten_rose_gold",       Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenPigIron        = FLUIDS.register("molten_pig_iron",        Material.LAVA, 10);

  public static final FluidObject<SimpleFlowableFluid> moltenManyullyn   = FLUIDS.register("molten_manyullyn",    Material.LAVA, 11);
  public static final FluidObject<SimpleFlowableFluid> moltenHepatizon   = FLUIDS.register("molten_hepatizon",    Material.LAVA,  8);
  public static final FluidObject<SimpleFlowableFluid> moltenQueensSlime = FLUIDS.register("molten_queens_slime", Material.LAVA,  9);
  public static final FluidObject<SimpleFlowableFluid> moltenSoulsteel   = FLUIDS.register("molten_soulsteel",    Material.LAVA,  6);
  public static final FluidObject<SimpleFlowableFluid> moltenNetherite   = FLUIDS.register("molten_netherite",    Material.LAVA, 14);
  public static final FluidObject<SimpleFlowableFluid> moltenKnightslime = FLUIDS.register("molten_knightslime",  Material.LAVA, 12);

  // compat ores
  public static final FluidObject<SimpleFlowableFluid> moltenTin      = FLUIDS.register("molten_tin",      Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenAluminum = FLUIDS.register("molten_aluminum", Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenLead     = FLUIDS.register("molten_lead",     Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenSilver   = FLUIDS.register("molten_silver",   Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenNickel   = FLUIDS.register("molten_nickel",   Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenZinc     = FLUIDS.register("molten_zinc",     Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenPlatinum = FLUIDS.register("molten_platinum", Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenTungsten = FLUIDS.register("molten_tungsten", Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenOsmium   = FLUIDS.register("molten_osmium",   Material.LAVA,  4);
  public static final FluidObject<SimpleFlowableFluid> moltenUranium  = FLUIDS.register("molten_uranium",  Material.LAVA, 15);

  // compat alloys
  public static final FluidObject<SimpleFlowableFluid> moltenBronze     = FLUIDS.register("molten_bronze",     Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenBrass      = FLUIDS.register("molten_brass",      Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenElectrum   = FLUIDS.register("molten_electrum",   Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenInvar      = FLUIDS.register("molten_invar",      Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenConstantan = FLUIDS.register("molten_constantan", Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenPewter     = FLUIDS.register("molten_pewter",     Material.LAVA, 10);
  public static final FluidObject<SimpleFlowableFluid> moltenSteel      = FLUIDS.register("molten_steel",      Material.LAVA, 13);

  // mod-specific compat alloys
  // thermal
  public static final FluidObject<SimpleFlowableFluid> moltenEnderium = FLUIDS.register("molten_enderium", Material.LAVA, 12);
  public static final FluidObject<SimpleFlowableFluid> moltenLumium   = FLUIDS.register("molten_lumium",   Material.LAVA, 15);
  public static final FluidObject<SimpleFlowableFluid> moltenSignalum = FLUIDS.register("molten_signalum", Material.LAVA, 13);
  // mekanism
  public static final FluidObject<SimpleFlowableFluid> moltenRefinedGlowstone = FLUIDS.register("molten_refined_glowstone", Material.LAVA, 15);
  public static final FluidObject<SimpleFlowableFluid> moltenRefinedObsidian  = FLUIDS.register("molten_refined_obsidian",  Material.LAVA,  7);
