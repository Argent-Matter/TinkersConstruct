...
public class BlockDeferredRegister extends DeferredRegisterWrapper<Block> {
  ...
  public BlockDeferredRegister(String modID) {
    ...
    this.itemRegister = SynchronizedDeferredRegister.create(Registry.ITEM, modID);
  }
  ...
  public WoodBlockObject registerWood(String name, Function<WoodVariant,BlockBehaviour.Properties> behaviorCreator, boolean flammable, CreativeModeTab group) {
    WoodType woodType = WoodType.register(new WoodType(name));
    ...
    ItemObject<ButtonBlock> button = register(name + "_button", () -> new WoodButtonBlock(redstoneProps), burnableItem.apply(100));
    // signs
