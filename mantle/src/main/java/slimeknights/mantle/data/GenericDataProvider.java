...
public abstract class GenericDataProvider implements DataProvider {
  ...
  public GenericDataProvider(FabricDataGenerator generator, PackType type, String folder) {
    this(generator, type, folder, GSON);
  }

  public GenericDataProvider(FabricDataGenerator generator, String folder, Gson gson) {
    this(generator, PackType.SERVER_DATA, folder, gson);
  }

  public GenericDataProvider(FabricDataGenerator generator, String folder) {
