...
public class MantleLoot {
  ...
  public static void registerGlobalLootModifiers() {
    RegistryAdapter<Codec<? extends IGlobalLootModifier>> adapter = new RegistryAdapter<>(PortingLibRegistry.GLOBAL_LOOT_MODIFIER_SERIALIZERS.get(_REGISTRY), Mantle.modId);
