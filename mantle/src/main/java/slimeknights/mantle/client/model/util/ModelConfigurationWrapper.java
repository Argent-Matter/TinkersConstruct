...
public class ModelConfigurationWrapper extends BlockModel {
  ...
  @Override
  public BakedModel bake(ModelBakery modelBaker, Function<Material, TextureAtlasSprite> function, ModelState modelState, ResourceLocation resourceLocation) {
    return base.bake(modelBaker, function, modelState, resourceLocation);
  }

  @Override
  public BakedModel bake(ModelBakery modelBaker, BlockModel blockModel, Function<Material, TextureAtlasSprite> function, ModelState modelState, ResourceLocation resourceLocation, boolean bl) {
