...
public class ModelItem {
  ...
  private static ItemTransforms.TransformType parseTransformType(JsonObject json, String key) {
    ...
    switch (name) {
      case "none":   return ItemTransforms.TransformType.NONE;
      case "head":   return ItemTransforms.TransformType.HEAD;
      case "gui":    return ItemTransforms.TransformType.GUI;
      case "ground": return ItemTransforms.TransformType.GROUND;
      case "fixed":  return ItemTransforms.TransformType.FIXED;
      case "thirdperson_righthand": return ItemTransforms.TransformType.THIRD_PERSON_RIGHT_HAND;
      case "thirdperson_lefthand":  return ItemTransforms.TransformType.THIRD_PERSON_LEFT_HAND;
      case "firstperson_righthand": return ItemTransforms.TransformType.FIRST_PERSON_RIGHT_HAND;
      case "firstperson_lefthand":  return ItemTransforms.TransformType.FIRST_PERSON_LEFT_HAND;
    }
  ...
  public static ModelItem fromJson(JsonObject json) {
    ...
    ItemTransforms.TransformType transformType = parseTransformType(json, "transform");
